...
iteration = 0
bs = 1
dataset_config_dir = 'datasets/airplane/dataset_config'
output_result_dir = 'experiments/eval_result/airplane'
...
testdataset = PoseDataset_airplane('eval', num_points, False, opt.dataset_root, 0.0, True)
